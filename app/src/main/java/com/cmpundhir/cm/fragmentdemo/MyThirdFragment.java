...
public class MyThirdFragment extends Fragment {
    ...
    public static MyThirdFragment newInstance(String param1, String param2) {
        MyThirdFragment fragment = new MyThirdFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_my_third, container, false);
        TextView txt = view.findViewById(R.id.frag3Txt);
